		...
		<tr>
			<td>
				...
				<span class="TB-BODY">
					...
					"the 330 Ohm resistor will be used as a pull down resistor, so that the button outputs a LOW level when not pressed, and HIGH when pressed."  --or some variation on that idea
