...
<cf_Box NoMargins="1">
	...
	<table class="TBLAYOUT" style="width:100%;" cellpadding="0">
	  ...
	  <tr>
		...
		port, <KEYWORD3>Serial</KEYWORD3>,  does double duty in that it both communicates through
	...
	<table class="TBLAYOUT" style="width:100%;" cellpadding="0">
	  <tr>
		...
		<span class="TB-BODY">
		  ...
		  We'll call it <BLACK>stateLEDGlb</BLACK>. Since this is a state variable
		  ...
		  <BLACK>buttonCurrentGlb</BLACK> and <BLACK>buttonLastGlb</BLACK>, respectively, since
		  ...
		  Let these two varibles be called <BLACK>timeCurrentGlb</BLACK> and 
		  <BLACK>timeLastGlb</BLACK>. 
		  ...
		  Lets call this variable <BLACK>secondsGlb</BLACK>.<br/><br/>
	...
	<table>
	  <tr>
		...
		the variable <BLACK>stateLEDGlb</BLACK>. The final step in the <code>setup()</code>
	...
	<table>
	  <tr>
		...
		and that the change is from <LITERAL1>LOW</LITERAL1> to <LITERAL1>HIGH</LITERAL1>. Using a conditional statement introduced
		...
		<code>digitalRead()</code> to the <BLACK>buttonCurrentGlb</BLACK>. Then, in the 
		conditional statement, we check to see if the <BLACK>buttonCurrentGlb</BLACK> is <LITERAL1>HIGH</LITERAL1> and if
		it is different from <BLACK>buttonLastGlb</BLACK>. This conditional statement should
		...
		assigning <BLACK>timeCurrentGlb</BLACK> to it. Now that we have the current time and 
