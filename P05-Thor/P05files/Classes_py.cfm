		...
		<tr>
			<td>
					...
					<span class="TB-BODY">
						...
						The <span class="TB-BLACK">struct</span> is used to define a data type built from other data types, 
						...
						it can be represented by <code>char*</code> (don't worry about <code>char*</code> 
						does or how to use it, this is for example), an ID is simply a number so an 
						integer can be used, and GPA often has a decimal point so double (or float) would 
						work. The following shows how to define this "student" <span class="TB-BLACK">struct</span>:
...
struct student {
  ...
  double GPA;
						...
						you couldn't just type <span class="TB-BLACK">student S</span>, instead you'd have to type
						<span class="TB-BLACK">struct student S</span>. Programmers being an efficient bunch, use the 
...
typedef struct {
  ...
  double GPA;
						...
						Now instead of having to type <span class="TB-BLACK">struct student S</span>, we instead can just
						type <span class="TB-BLACK">Student S</span>. Note how the syntax changes between the structs with
					...
					<span class="TB-BODY">
						...
						<span class="TB-BLACK">structVariable.memberVariable</span>, where "structVariable" is a variable
...
exampleStudent.GPA  = 3.2;
						...
						Data structures (which will not be covered here) use structs and a number of
						functions that store and access the data in that data structure. <br/>
					</span>
			</td>
		</tr>
	</table>
		...
		<tr>
			<td>
					...
					<span class="TB-BODY">
						...
						(actually three, but protected gets into more advanced programming) specifiers 
						that either make it so a member variable function can only be accessed or modified
						by anyone or by a method of that class. Members that are public act just like a 
						struct, i.e. public members can be accessed and modified by using the "." operator.
	...
	public:
		...
		Student(){
			...
			GPA = 0;
						...
						a <span class="TB-BLACK">Student</span><span class="TB-BLACK">()</span> method definition in this class; it is called the default
						...
						<span class="TB-H2">student.h</span>
<div align="center">
        <cf_box color="white" style="width:95%; margin:8em 0 8em 0 ">
        <pre class="brush:mpide;">
#include &lt;String&gt;
...
Student::Student(){
	...
	GPA=0;
					...
					<span class="TB-BODY">
						...
						<span class="TB-BLACK">classVariable.memberVariable</span>, where "classVariable" is some variable
