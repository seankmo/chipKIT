<html>
	...
	<tr>
	<td>
	<span class="TB-H1">Open</span><a name="Open">
	<br><br>
	<span class="TB-BODY">
		Two points in a circuit are considered to be “open” when there is no longer a path for
		current to flow between them.  This occurs when there is so much resistance between the
		two points that current can no longer flow between them.  Resistance is defined here as
