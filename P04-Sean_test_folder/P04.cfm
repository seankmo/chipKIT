<html><head><title>Button Controlled LEDs</title>
...
<!--  Intro portion -----------------------------   --->
    ...
    <hr hr="" color="#2c2c2c" size="15">
        <span class="TB-BODY"><p class="MsoNormal">This project will demonstrate how
        to use buttons to turn on and off light
        emitting diodes (LEDs). You are probably already familiar with
        traditional light switches that directly control whether or not
        electrical energy is delivered to a light bulb. In this project, three
        buttons are used to control three LEDs, but the buttons
        are <i>not</i> directly connected to the LEDs. Instead,
        the buttons
        are used to establish voltages that are "read" via the chipKIT digital
        input/output (I/O) pins. From these voltages, we can determine if a
        button is pressed or not (i.e., we can determine a button's
        "state"). Each LED is then illuminated in accordance with the state
        of the corresponding button.
            ...
            <br>
            <div class="TB-FIGURES"><span style="font-style: italic;">Fig. 1. Button Controlled LED
            circuit</span>.</div>
            </td>
            </tr>
            <tr>
...
<br>
    ...
    <tr>
    <td colspan="1"><br>
        <table style="text-align: left; width: 85%;" border="0" cellpadding="0" cellspacing="0">
        <tbody>
        <tr>
        <td style="text-align: center;"><img style="width: 100%; height: 100%;" alt="LEDsetup" src="P04files/Just_LEDs_3_20_2013.png"><br>
        <div class="TB-FIGURES"><span style="font-style: italic;">Fig. 2.
        LED configuration.</span></span></td>
        </tr>
        </tbody>
        </table>
    <br>
    ...
    <ol><span class="TB-BODY">
        ...
        (the anode is the longer leg).&nbsp;</li>
        <li>
        ...
        or by using a small wire to connect from a column in the main section of the breadboard to the ground bus strip (as in Figure 2).&nbsp;</li>
    ...
    <br>
        ...
        through the other) then we say the components are <a href="P04_KVL_KCL.html#SER"><i>in series</i></a>.
        ...
        depth in <font color="#0000ff">Project 3: Blink External LED.</font>
        </p>
        </li>
        </ol>
    </span>
...
<!--  Theory -----------------------------   --->
    ...
    <tr>
    <td>
        <br><br><span class="TB-H2">
    Theory: Buttons, Pull-Down Resistors, and Pull-Up Resistors
    <hr hr="" align="left" color="#2c2c2c" size="2" width="50%"></span></td>
    </tr>
    </tbody>
    </table>
    ...
    <span class="TB-BODY">Before connecting the buttons to the circuit, it is appropriate to
...
<td>
    ...
    <table style="text-align: left; width: 85%; height: 502px;" border="0" cellpadding="0" cellspacing="0">
    <tbody>
    <tr>
    <td style="vertical-align: top; text-align: center;"><img style="width: 218px; height: 238px;" alt="realbtn" src="P04files/realbtnplaceholder.png"><br>
    <div class="TB-FIGURES"><span style="font-style: italic;">Fig. 3.
    Four-port button.</span></span></td>
    <td style="text-align: center; vertical-align: middle;"><img style="width: 250px; height: 182px;" alt="btn diagram" src="P04files/btndiagram.png"><br>
    <p class="MsoNormal"><div class="TB-FIGURES"><span style="font-style: italic;">Fig. 4. Four-port button
    schematic symbol.</span></p>
    </td>
    </tr>
    <tr>
        
        
    <td style="vertical-align: top;"><span class="TB-BODY">If you were
    ...
    between the terminals of the device. <br><br><br>
     </span>
    </td>
    <td style="text-align: center;"><img style="width: 145px; height: 214px;" alt="btndiagram" src="P04files/btn2diagram.png"><br>
    <p class="MsoNormal"><div class="TB-FIGURES"><span style="font-style: italic;">Fig. 5. Two-port button
    schematic symbol.</span></span></p>
    </td>
    </tr>
    </tbody>
    </table>
    ...
    <div class="TB-FIGURES"><span style="font-style: italic;">Fig. 6. Basic
    button circuit with pull-down resistor pressed.</span></span></td>
    </tr>
<tr>
...
<td colspan="1">
    ...
    <span class="TB-BODY">
    <p style="margin-bottom: 0in;"><br>Figure 6 shows a
    ...
    circuit's <span style="font-style: italic;">ground</span>.&nbsp;
    Within chipKIT, the 5V voltage supply is synonymous with the 5V
    pin, and ground corresponds to the GND pin.<br>
    </p>
    ...
    they would see approximately 5 volts.<br>
    </p>
    </span>
</td>
</tr>
<tr>
    ...
    <div class="TB-FIGURES"><span style="font-style: italic;">Fig. 7. Basic
    button circuit with pull-down resistor, not pressed</span></span></td>
    </tr>
    <tr>

    <td colspan="1">
        <span class="TB-BODY">
    <p style="margin-bottom: 0in;"><br>When the button is
    not pressed, the
    physical connection between the ports of the button is no longer present.
    This is now considered to have an <a href="P04_KVL_KCL.html#Open">"open"</a> condition.&nbsp;An<a href="P03_KVL_KCL.html">
    ...
    longer there,<span style="">&nbsp; </span>current
    can&#8217;t flow between them. Measuring again at
    the same point, the multimeter would now read approximately 0
    volts.&nbsp;&nbsp;</p>
    <p style="margin-bottom: 0in;"></p>
    <p style="margin-bottom: 0in;">A resistor placed as shown above in Figure 7 would be considered to be a <span style="font-weight: bold;">pull-down resistor</span>.
    Without it pressing the button would <a style="font-style: italic;" href="P04_KVL_KCL.html#Short">"short"</a> the power
    source. A circuit is considered to have a <a href="P04_KVL_KCL.html#Short">short</a>
    condition when a new path in the circuit is introduced with little to no resistance.<span style="">&nbsp;
    </span>Since there is little, if any, opposition to
    ...
    components and cause incorrect circuit operation.<br><br><font color="#000000"><span style="font-weight: normal;"></span></font></p>
    <p style="margin-bottom: 0in;"></p>
...
<td>
    ...
    <tbody>
    <tr>
    <td style="text-align: center;"><img style="width: 330px; height: 240px;" alt="Switch Example" src="P04files/switchExample.png"><br>
    <div class="TB-FIGURES"><span style="font-style: italic;">Fig. 7a.
    Non pressed button circuit diagram</span></span></td>
    <td style="text-align: center;"><img style="width: 330px; height: 240px;" alt="Switch Closed" src="P04files/switchExample2.png"><br>
    <div class="TB-FIGURES"><span style="font-style: italic;">Fig. 7b.
    Pressed button circuit diagram</span></span></td>
    </tr>
    </tbody>
    </table>
    </td>
...
<td>
    <span class="TB-BODY">
    <p class="MsoNormal"><br>Another way of thinking about
    this is to examine the circuit
    diagrams of Figs. 7a and 7b.<span style="">&nbsp; </span>In
    7a,
    ...
    incomplete
    circuit (no current is flowing through the loop). <span style="">&nbsp;</span>Since
    the open occurs before the point we are
    measuring, there is no voltage difference between that point and
    ground, and
    it should measure 0 v.<span style="">&nbsp; </span></p>
    <p class="MsoNormal">In Figure 7b, you can see that
    the loop is now completed when the button ins pressed. <span style="">&nbsp;</span>In
    this
    simple circuit the resistor and voltage sources are the only components
    in the
    circuit. <span style="">&nbsp;</span>For simplicity's sake,
    ...
    (As we have done in this case.)   </p>
    <p class="MsoNormal"><a href="P04_KVL_KCL.html#KVL">Kirchhoff&#8217;s
    voltage law
    (KVL)</a> states that the sum of all voltages
    (both supplied voltages and voltage drops) around a closed loop in a circuit must be
    equal to
    zero.<span style="">&nbsp; </span>A voltage
    drop is defined as the
    voltage difference before and after a single component. <span style="">&nbsp;</span>So for Figure 7b, if the
    voltage source supplies
    5V, the voltage drop across the resistor must also equal 5V.</p>
    <p class="MsoNormal"><a href="P04_KVL_KCL.html#KVL">More
    information about
    analyzing circuits using Kirchhoff&#8217;s
    voltage law is contained in this project's appendix.</a> </p>
    <p class="MsoNormal">&nbsp;</p>
    <p class="MsoNormal"></p>
    </td>
    </tr>
...
<tr>
    <td><span class="TB-BODY">The button circuit could be alternatively configured
    ...
    is then connected to ground.<br><br></span></td>
    </tr>
</span>
<tr>
    <td style="text-align: center;" colspan="1"><img style="width: 364px; height: 308px;" alt="btn2" src="P04files/btn2.png"><br><br>
    <div class="TB-FIGURES"><span style="font-style: italic;">Fig. 8. Alternative button
    configuration, not pressed.</span></span>
    </td>
    </tr>
...
<tr>
    ...
    When the button is not pressed, an <span style="color: black;"><a href="P04_KVL_KCL.html#Open">open</a>
    is formed</span> between the resistor and ground. While the
    button is in an
    ...
    voltage drop
    across the resistor.<span style="">&nbsp; </span>The
    points before and
    ...
    resistor will
    measure the same 5 volts with respect to ground.</p>
    <p style="margin-bottom: 0in;"></p>
    </td>
    </tr>
        </span>
...
<tr>
    ...
    <div class="TB-FIGURES"><span style="font-style: italic;">Fig. 9.
    Alternative button configuration, pressed.</span></span></td>
    </tr>
    <tr>

    
    <td colspan="1"><span class="TB-BODY">Now when the button is pressed, a
    ...
    measure 0 volts. This configuration of resistor would be considered a <span style="font-weight: bold;">pull-up resistor</span>.<br>
    <br>
    <br>
    ...
    of the pull-down resistor button circuit.<br>
    </td>
    </tr>
    <tr>
    ...
    <tr>
    <td style="text-align: center;" colspan="1"><img style="width: 700px; height: 616px;"
    alt="button set up" src="P04files/Justbuttons_3_20_2013.png"><br>
    <div class="TB-FIGURES"><span style="font-style: italic;">Fig. 10. Button
 ...
 <!--  Part 2 actual instructions -----------------------------   --->   
    <ol>
        <span class="TB-BODY">
        <li>Connect the chipKIT 5V pin to a bus strip close to the ground bus strip (this was set up in step 1).
        ...
        absolutely necessary, it will provide you more room to work.<br>
        </li>
        <li> Using three wires, connect the top
        terminal of each button to the 5V bus strip.&nbsp; <br>
        </li>
        <li> Using three more wires, connect from the
        chipKIT digital I/O pins 5, 6 and 7 to the bottom terminal of buttons A,
        B, and C.&nbsp;&nbsp;</li>
        <li>For each button, connect one end of a 10k-ohm
        resistor to the bottom terminal of the button.&nbsp;</li>
        <li>Connect the other end of each resistor to the
        ground bus strip (you can use a wire to connect
        from the resistor to bus strip, as shown in Figure 10, or you can simply
        connect the end of the resistor to the bus strip directly).<br>
        </li>
        <li>When each button is pressed, it will supply 5 volts to the digital I/O
        ...
        and Uno32 can only accept a max of 3.3V).<br>
        <br>
        </li>
    </ol>
    </td>
...
<td style="text-align: center;" colspan="1"><img style="width:700px; height: 616px;" alt="overallcirc" src="P04files/Overall_cir_3_20_2013.png"><br>
<div class="TB-FIGURES"><span style="font-style: italic;">Fig. 11: Overall
Circuit</span></span><br><br></td>
</tr>

<tr>
<td>
  <span class="TB-BODY">
    <br>Figure 11 illustrates the overall setup of the circuit, including both buttons and LEDs.<br><br>
...
<!--  Part 3 software  -------------------------------------------------------->
    <td colspan="1"><span class="TB-H1">Step
    3: Software
    ...
    <span class="TB-H2">Theory: The "IF"
    and
    comparison statements:</span>
    <hr hr="" align="left" color="#2c2c2c" size="2" width="50%"></span><br>
    <br>
        <span class="TB-BODY">
    In order to better understand what the chipKIT
    is doing in conjunction with MPIDE, it is important to
    provide a brief explanation of the <code>if</code> conditional statements and
    <code>digitalRead</code> functions before running the sketch . <br>
    <br>
    The <code>digitalRead</code> command operates much as
    ...
    of the pin, and output either a HIGH or LOW constant accordingly.<br>
    <br>
    ...
    <code>Val</code> would store the result of the <code>digitalRead</code> function called for pin
    8.&nbsp; If pin 8 sees a high voltage level on the pin at the time
    the function
    is called, <code>Val</code> would equal HIGH, and if not <code>Val</code> would equal LOW.<br>
    <br>

    Along with supporting all of the original Arduino syntax, chipKIT
    sketches are based on C++ syntax and thus most conventions apply.<br>
    An &#8220;if&#8221; comparison statement syntax would be as follows:<br>
    <br>
    </td>
    </tr>
...
<td>
        ...
        <cf_box color= "white"
	style="width:95%"> 
    <table style="text-align: middle; width: 100%;" border="0" cellpadding="0" cellspacing="0">
    <tbody>
    <tr>
    <td><span style="color: rgb(0, 102, 0);">
    <pre class="brush: mpide;">if ( comparison expression){
    ... task......
    }
    else{
    ...do something else ...
...
<td>
 ...
 <span class="TB-BODY">Within the “if” statement you can see that there is a comparison expression.
...
just “equal” and “not equal”. The following table shows a few of these relational operators.</span>
...
<tr>
    ...
    <tr>
    <td style="text-align: center;" colspan="2"><span style="color: rgb(0, 102, 0);"></span><br>
    

    <table style="text-align: left; width: 100%;" border="1" cellpadding="0" cellspacing="0" bgcolor="white">
    <tbody>
    <tr>
    <td>Equal</td>
        <td>&nbsp; ==</td>
    ...
    <tr>
    <td>Logical AND:<br>this operator is used to combined multiple comparison expressions into one expression.
            (ie  if expression A is true and expression B is true then the overall expression is also true.)</td>
        <td>&nbsp; &amp;&amp;</td>
    </tr>
    <tr>
    <td>Logical OR:<br>Like logical “AND”, this operator is used to combined multiple expressions.
            An example would be, if expression A is true or expression B is true then the overall expression is true.</td>
...
<tr>
    <td><br>
     <span class="TB-BODY">An example of an &nbsp;"if" statement used in the project code:</span><br>
    </td>
    <td></td>
    </tr>
    <tr>
	...
	style="width:95%"> 
        ...
        <tr>
        <td><span style="color: rgb(0, 102, 0);">
        <pre class="brush: mpide;">if (digitalRead(BtnA) == HIGH) {
        &nbsp;
        ...
        <td> <span class="TB-BODY">Once the if statement is executed, the <code>digitalRead</code>
        function will
        execute and then return a value. That returned value is then compared
        to the constant value HIGH.<br>
 

        <br>
        Stated more plainly, the syntax reads,
        "If Button A is pressed, turn on LedA, else turn off LedA."<br>
        Multiple statements
        can be used along
        with the logical "<span style="font-weight: bold;">And</span>",
        and logical "<span style="font-weight: bold;">Or</span>"
        statements<br>
        for example:</span>
        <p style="margin-bottom: 0in;"></p>
        </td>
...
<td>
    ...
    <span class="TB-BODY">We could also say this more simply:<br>
    " If the Read value of ButtonA and ButtonB are true,
    digitalWrite LedC to&nbsp; HIGH"<br>
    <br>
    For an explanation of
    functions, <font color="#000080">
    Project 2</font> provides an overview of syntax and program
    structure.</span>
    </td>
    </tr>
        </span>
    ...
    <table class="TBLAYOUT" style="width: 85%; cellpadding="0">
    <tbody>
    <td colspan="2"><span class="TB-H2">Software Set up:</span>
    <hr hr="" align="left" color="#2c2c2c" size="2" width="50%"><br>
    <span style="color: rgb(0, 102, 0);"></span><br>
    </td>
    </tr>
    <tr>
    <td colspan="2"><span style="color: rgb(0, 102, 0);"><br>
    </span>
    
    <span class="TB-BODY">The following is
    the source code for this
    project and an explanation is provided in comments<br><br></span>
    <p style="margin-bottom: 0in;"></p>
...
<tr>
<td colspan="2"><br>
<p style="margin-bottom: 0in;"><span class="TB-H1">Implementation and
Summary&nbsp;</span>

<!-- Summary table --------------------------------------->
<span class="TB-BODY">
    <hr hr="" color="#2c2c2c" size="15"></span></p>
    <span class="TB-BODY">Once the sketch is
    uploaded to the chipKIT board, the circuit will be fully functional.
    The circuit can be easily tested by pressing button A
    to turn on LED A, button B to turn on LED B, and button C to LED C. <br><br>
    In summary, the following new concepts and software
    functions were introduced:<br>
    <br>
        ...
        <tbody>
        <tr>
            <td style="text-align: left; vertical-align: top;">Button
            operations</td>
            </tr>
            <tr>
            <td>"If" statements</td>
