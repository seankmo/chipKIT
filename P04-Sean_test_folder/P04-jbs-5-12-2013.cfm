				...
				<cf_box color="putty">
					...
					<span class="TB-BODY">
						...
						<ol>
							...
							<li>
								Connect the chipKIT ground pin (labeled &ldquo;GND&rdquo;) to a bus strip at
								the bottom of the breadboard.  There are multiple GND pins and they are all
								equivalent.  In Fig. 2, the jumper wire is connected to the GND pin closest
								to the 5V pin.
								<ul>
									<li>
										In Fig. 2, the breadboard bus strips are the two bottom-most and two
										top-most horizontal rows.  All the holes along a row are electrically
							...
							<li>
								Now, attach one end of a 330 &Omega; resistor to the cathode of each of the
		...
		<tr>
			<td>
				...
				<span class="TB-BODY">
					...
					<cf_imagebox align="right"
					             path="P04files/two-port-button-schematic.png"
					             width="215px"
					             caption="Fig. 4. Two-port button schematic symbol.">
					...
					<cf_imagebox align="right"
					             path="P04files/button-simple-schematic.png"
					             width="215px"
					             caption="Fig. 5. Simplified button schematic.">
