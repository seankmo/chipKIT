		  ...
		  <table class="TBLAYOUT" style="width: 85%;" cellpadding="0">
			...
			<td style="text-align: center;" colspan="1"><br>
			  ...
			  <table class="TBLAYOUT" align="center" cellpadding="0">
				...
				<td>
				  <img style="width: 250px;" alt="btn0" 
			  ...
			  <div class="TB-FIGURES">
			    <span style="font-style:
			      italic;">Fig. 6. Button circuit with a
			      pull-down resistor and the button open.
			      (a) Voltmeter attached to 3.3V supply.
			      (b) Voltmeter attached to ground.
			    </span>
			  </div>
			</td>
		      </tr>
			...
			<td style="text-align: center;" colspan="1"><br>
			  <br>
			  <img style="width: 300px;" alt="btn0" 
			       src="P04files/pull-down-resistor-switch-open-3.png">
			  <br><br>
			  <div class="TB-FIGURES">
			    <span style="font-style:
			      italic;">(c) Voltmeter attached before
			      resistor.
			    </span>
			  </div>
			</td>
			...
			<td style="text-align: center;" colspan="1"><br>
			  ...
			  <div class="TB-FIGURES">
			    <span style="font-style:
			      italic;">Fig. 7. Button circuit with a
			      pull-down resistor where the button is
			      pressed and the circuit is closed.
			    </span>
			  </div>
			</td>
		      </tr>
			...
			<td style="text-align: center;" colspan="1"><br>
			  ...
			  <div class="TB-FIGURES">
			    <span style="font-style:
			      italic;">Fig. 8. Basic circuit with
			      button and pull-up resistor where the
			      button is open.
			    </span>
			  </div>
			</td>
			...
			<td style="text-align: center;" colspan="1"><br>
			  ...
			  <div class="TB-FIGURES">
			    <span style="font-style:
			      italic;">Fig. 9. Basic circuit with
			      button and pull-up resistor where the
			      button is closed/pressed.
			    </span>
			  </div>
			</td>
		      </tr>
			...
			<td colspan="1">
			  <span class="TB-BODY">
			    <p style="margin-bottom: 0in;">
			      ...
			      circuits with buttons, we must
			      understand how to interpret what we're
			      seeing. Figure 6(a) and (b) shows a
			      button circuit with a pull-down resistor
			      with the button open. The circuits are
			      hooked up to a voltmeter, which allows
			      us to read the voltages at different
			      points in the circuit. In Fig. 6(a), the
			      voltmeter reads 3.3V, in spite of the
			      fact that the button is open. This is
			      because the measurement was taken at the
			      3.3V voltage sources. If we took the
			      same measurement at ground or even
			      before the resistor as in Figs. 6(b) and
			      (c), the voltmeter reads 0 V. Even
			      though 3.3 V are being generated, the
			      circuit is open. No power is supplied at
			      ...
			      resistors immaterial in determining
			...
			<ol>
			  <span class="TB-BODY">
			    ...
			    <li> Place buttons A , B, and C, onto the
			      ...
			      to Fig. 14), so that the left and
			    ...
			    <li>Connect the other end of each resistor
			      ...
			      strip, as shown in Fig. 11, or you can
		...
		<table class="TBLAYOUT" style="width: 85%;" cellpadding="0">
		  <tbody>
		    ...
		    <tr>
		      <td>
			<span class="TB-BODY">
			  <br>Figure 15 illustrates the overall setup
