      ...
      <tbody>
		...
		<cf_box color= "green" style="width:95%">
		  <table class="TBLAYOUT" style="width: 85%;" cellpadding="0">
			...
			<td style="text-align: center;" colspan="1"><br>
			  ...
			  <div class="TB-FIGURES">
			    <span style="font-style:
			      ...
			      pulldown resistor and the button open.
			...
			<td style="text-align: center;" colspan="1"><br>
			  ...
			  <div class="TB-FIGURES">
			    <span style="font-style:
			      italic;">Fig. 6. Basic circuit with
			      button and pull-down resistor where the
			      button is pressed.
			    </span>
			  </div>
			</td>
			...
			<td colspan="1">
			  <span class="TB-BODY">
			    <p style="margin-bottom: 0in;">
			      ...
			      circuit with a button.&nbsp; The circuit
			      is constructed by using a wire to
			      connect the top of the button to a 5V
			      voltage supply and the bottom to a
			...
			<td colspan="1">
			  <span class="TB-BODY">
			    ...
			    <p style="margin-bottom: 0in;">A resistor
			      placed as shown above in Fig. 7 would
			      be considered to be
			...
			<td>
			  <table style="text-align: left; width: 85%;"
				...
				<td style="text-align: center;">
				  ...
				  <br>
				  <div class="TB-FIGURES">
				    <span style="font-style: italic;">Fig. 8a.
				...
				<td style="text-align: center;">
				  ...
				  <div class="TB-FIGURES">
				    <span style="font-style: italic;">Fig. 8b.
			...
			<td>
			  <span class="TB-BODY">
			    <p class="MsoNormal"><br>Another way of
			      ...
			      V. </p>
			    <p class="MsoNormal">In Fig. 8b, you can
			...
			<td style="text-align: center;" colspan="1">
			  ...
			  <br><br>
			  <div class="TB-FIGURES">
			    <span style="font-style: italic;">Fig. 9. Alternative button
			...
			<td style="text-align: center;" colspan="1">
			  ...
			  <br><br>
			  <div class="TB-FIGURES">
			    <span style="font-style: italic;">Fig. 10.
		...
		<table class="TBLAYOUT" style="width: 85%;" cellpadding="0">
		  <tbody>
			...
			<br><br>
			<div class="TB-FIGURES">
			  <span style="font-style: italic;">Fig. 11. Button
			    configuration.
			  </span>
			</div>
			<br><br>
			...
			<ol>
			  <span class="TB-BODY">
			    ...
			    <li> Place buttons A , B, and C, onto the
			      ...
			      to Fig. 11), so that the left and
		...
		<table class="TBLAYOUT" style="width: 85%;" cellpadding="0">
		  <tbody>
			...
			<div class="TB-FIGURES">
			  <span style="font-style: italic;">Fig. 12: Overall
			    Circuit
			  </span>
			</div>
			<br><br>
		    ...
		    <tr>
		      <td>
			<span class="TB-BODY">
			  <br>Fig. 12 illustrates the overall setup
