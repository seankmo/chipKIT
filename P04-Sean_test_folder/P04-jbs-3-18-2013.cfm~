	    ...
	    <br><br>
          ...
          <td style="width: 320px; text-align: left; vertical-align: top;">
            &nbsp;<img style="width: 279px;"
		       alt="Button Controlled LED circuit" src="P04files/Overallcirc.png"><br>
            <br>
			...
			<td>
			  <span class="TB-BODY">
			    <p class="MsoNormal"><br>Another way of
			      ...
			      V. </p>
			    <p class="MsoNormal">In Fig. 7b, you can
			...
			<ol>
			  <span class="TB-BODY">
			    ...
			    <li> Place buttons A , B, and C, onto the
			      ...
			      to Fig. 10), so that the left and
		...
		<table class="TBLAYOUT" style="width: 85%;" cellpadding="0">
		  <tbody>
		    ...
		    <tr>
		      <td>
			<span class="TB-BODY">
			  <br>Fig. 11 illustrates the overall setup
