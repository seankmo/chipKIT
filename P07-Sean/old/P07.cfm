...
<br>
  ...
  interval of time apart. An output signal (the debounced version of the input signal) is driven <span class="TB-LITERAL1">HIGH</span> or <span class="TB-LITERAL1">LOW</span> based on receiving
  ...
  <span class="TB-LITERAL1">HIGH</span> (meaning the signal currently is <span class="TB-LITERAL1">HIGH</span>, and 1/10th of a second ago the signal was also <span class="TB-LITERAL1">HIGH</span>), it is safe to say the signal
  is in a <span class="TB-LITERAL1">HIGH</span> state. (Likewise <span class="TB-LITERAL1">LOW</span> if two consecutive <span class="TB-LITERAL1">LOW</span> samples are received). In general practice only two samples are ever needed
