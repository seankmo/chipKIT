	  ...
	  <tr>
		  <td>
			  ...
			  <span class="TB-BODY"> As we previously mentioned, bounce
				  ...
				  and the blue showing thevoltage over time signal that is
				  ...
				  the button, and then, if <code>HIGH</code>, will drive
				  the corresponding LED <code>HIGH</code>. Like Fig. 1,
				  ...
				  remains <code>LOW</code> until time T4.  At this point
				  the output signal is driven <code>HIGH</code> because T4
				  and the previous point T3 were both <code>HIGH</code> .
			  </span>
		  </td>
	  </tr>
  </table>
