	...
	<table class="TBLAYOUT">
     ...
     <table class="TBLAYOUT">
      ...
      <span class="TB-BODY">		      
		      ...
		      HEREHEREHERE A potentiometer will always have three pins, where two are connected to opposite ends of a resistive material, Fig. 2. illustrates how the pins are connected. From Fig. 2. it is easy to see pins "A" and "C" are separated by the greatest length of resistive material. This means the resistance measured across both will always be the maximum value of the potentiometer. In our project the max resistance is 10k&Omega;.
