	...
	<table class="TBLAYOUT" style="width:100%;" cellpadding="0">
	  <tr>
	    ...
	    <td width="31%" align="center">
	      <img width="150" src="cable-usb-a-mini-b.svg" /><br/><br/>
		...
		<tr style="height:100%;">
		  ...
		  <td class="BOX-PUTTY-CONTENT" valign="top">
		    ...
		    <span class="TB-BODY">
		      ...
		      &ldquo;<span class="TB-BLACK">.zip</span>&rdquo; extension.  This
			...
			it will be
			called <span class="TB-BLACK">mpide-0023-windows-20120903</span>
			...
			&ldquo;<span class="TB-BLACK">Blink</span>&rdquo; (on the
			computer this is stored
			as <span class="TB-BLACK">Blink.pde</span>; the extension
			&ldquo;<span class="TB-BLACK">.pde</span>&rdquo; indicates that
			this file is a sketch).  Figure 7 indicates
			how this should appear.<br><br>

			<div align="center">
			  <img src="blinkexample.png" />
			  <div class="TB-FIGURES">Fig. 7. The <span class="TB-BLACK">Blink</span>
			    example sketch.
			    <br/><br/>
			  </div>
			</div>
			...
			this, select the menu <span class="TB-BLACK">Tools>Board</span>
			...
			Next, go to <span class="TB-BLACK">Tools>Serial Port</span> to
		    ...
		    <span class="TB-BODY">
		      ...
		      sketch. Normally, before uploading the sketch,
		      you would &ldquo;verify&rdquo; the sketch to
		      identify any bugs or errors in the code. This
		      can be accomplished in any one of three ways. As
		      indicated in Fig. 10(a), you can click the
		      Verify button.  Alternatively, you can click on
		      the menu
		      entry <span class="TB-BLACK">Sketch>Verify/Compile</span> or you
		      can type <code>Ctrl+R</code> (hold down the
		      control key and type the key R). You are welcome
		      to verify this sketch, but since it is one of
		      the provided example sketches, this isn't
		      necessary. Figure 10(b) through 10(e) shows some
		      of the other tools available in MPIDE.
		    ...
		    <span class="TB-BODY">
		      Whether or not a sketch has been verified, you
		      can &ldquo;upload&rdquo; it to a board.  If
		      there is a bug in the code that would have been
		      caught by verifying the sketch, it will still be
		      caught when you try to upload it. To upload the
		      sketch, you can click on the Upload button, as
		      indicated in Fig. 10(b).  You can also click on
		      the menu entry <code>File>Upload to I/O
		      Board</code> (I/O stands for input/output), or
		      type <code>Ctrl+U</code>.
		      ...
		      Finally, LED4 should start to blink! It will
		      continue to blink, being on for one second then off
		      for one second, until you remove the board from its
		      power source.  The way in which the code
		      accomplishes this blinking is covered in the next
		      project.
		    </span>
		  </td>
