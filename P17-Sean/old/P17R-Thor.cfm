<html>
  ...
  <cf_Box Color="White"> 
	...
	<tr>
	  ...
	  <br><br>
	  This project implements a servo control circuit that will use the chipKIT board to read button presses from a user, and move the position of a servo’s motor shaft accordingly.
	...
	<span class="TB-BODY">
	  ...
	  where the applied voltage is directly proportional to how fast 
	  the servo can rotate. It is important to never supply a negative voltage to the power line, as it could damage the servo.
	  A negative voltage is simply a voltage source that has a lower potential energy than ground. For chipKIT boards a negative
	  voltage is produced when you swap “power” and “ground” lines, which should be avoided.
	  In this project the power line will be connected to the 5V pin of the chipKIT board.
	  <br><br>
	 ...
	 The servo accepts PWM (Pulse Width Modulation) type signals, and can determine the desired angle by the “duty cycle” of the signal. 
	 <br><br>
	...
	<!--- this is a dead link for now, will eventually go an auxiliary page --->
  ...
  <br><br>
	...
	<br><br>
	Now take into consideration functions like <code>digitalRead()</code> and <code>digitalWrite()</code> (these are just a few examples).  We use these
	...
	<span class="TB-BODY">  
	  ...
	  <br><br>
	  The first step in controlling a servo is instantiating a <code>Servo</code> class object:
	  <br><br>
	  i.e.
	  <br><br>
	...
	<!--- another dead link,  will be added later --->
         <td align="right" valign="top" width="234">
            <cf_TextbookTabs Mode="top"  NextColor="red">
	...
	<td>
	  <span class="TB-BODY"> 
	  Once you have created your <code>Servo</code> class object, you need to use the “attach” method to tell the chipKIT board what pin the servo object will output to (this pin provides the PWM signal that will be fed to the servo’s control line). 
	  <br><br>
   ...
   delay(10);                            
    ...
    <table id="CT3">
	  ...
	  <tr>
	      ...
	      <li> <code>Servo.attach()</code></li>
	      <li> <code>Servo.read()</code></li>
	      <li> <code>Servo.write()</code></li>
