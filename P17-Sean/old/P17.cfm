<html>
  ...
  <cf_Box Color="White"> 
	...
	<span class="TB-BODY">
	 ...
	 <br><br>
	 Relating this to our project, when our servo receives a PWM signal that is asserted HIGH for 1 ms, the servo interprets this as an angle of
	 0 degrees (i.e. position the motor shaft at angle 0).  Conjointly, asserting HIGH for 2 ms relates to 180 degrees.  So then an angle
  ...
  <br><br>
	...
	<tr>
	  ...
	  <span class="TB-BODY">
	    <ul>
	    <li>Now implement the following project code. The variable “degree” will represent the position of the servo at any given time.
	    The sketch will check if a user has pressed the left button and decrements the “degree” variable by the value of the “myspeed” constant.
	    (Likewise if the right button is pressed the “degree” variable is incremented in the same fashion).  After the sketch finishes checking
