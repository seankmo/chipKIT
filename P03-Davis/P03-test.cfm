<html>
		...
		<tr>
			<td>
				...
				<span class="TB-BODY">
					...
					control an on-board LED. Now we will build our own external LED circuit and control it
					with the microcontroller. To do so, we must understand the properties of the circuit
					and its components.  If you are unfamiliar with the fundamentals of electricity and
					simple electronic components, <a href="P03files/P03Electric Review.cfm">a review of
   ...
   <table class="TBLAYOUT">
			...
			<tr>
				<td>		
					...
					<span class="TB-BODY">
						...
						Before we place wires between the breadboard and the chipKIT board, it is important
						to understand the internal connections within the breadboard.  Figure 1 shows a
						...
						different nodes.  On the left side of the breadboard, a wire has been used to
						establish a connection between nodes on either side of the valley.  The holes of
						these two nodes are highlighted in light blue.  To the right of this, a wire has
						been used to connect neighboring nodes on the same side of the valley.  These
						nodes are highlighted in red.  The holes of the three nodes highlighted in purple
						have been connected using two wires.  The wires we use in the projects will
						...
						<div align="center">
							<img src="P03files/Uno32%20Pins1.svg" width="500"> 
						...
						<div align="center">
							<img src="P03files/Max32%20Pins.svg" width="500"/> 
						...
						<span class="TB-BODY">
							...
							done by programming them to either <span class="TB-LITERAL1">HIGH</span> or <span class="TB-LITERAL1">LOW</span>, which
							we will discuss more thoroughly later.  When set to <span class="TB-LITERAL1">HIGH</span>, a
						...
						<div align="center">
							<img src="P03files/external%20led_bb.svg" width="500"> 
	...
	<span class="TB-BODY"> In the previous example, updating the pin values was relatively
	  ...
	  Instead, you can represent the pin values with variables. There
	  is <a href="P03files/P03Programing_Variables.cfm">more on using variables here</a>.  Variables
	  are a useful substitute for repetitive occurrences of values in your code. This is because when
	  you change a variable's value, all other references to that variable (that occupy the same
	  scope) are automatically updated.  Here is what the final code for the project looks like using
	  variables:
	</span>
	<br/><br/>  				
