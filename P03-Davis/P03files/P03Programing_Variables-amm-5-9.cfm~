...
<cf_Box Color="White" NoMargins="1">
  <table class="TBLAYOUT" style="width:100%;" cellpadding="0">
    ...
    <tr>
      <td valign="top">
      	<p>	    
			<span class="TB-H1">Variable</span> <br/><br/>
			 <span class="TB-BODY"> <!--this is a comment -->
				...
				There is <a href="">more on what a variable is in a previous project<a />.
			</span><br /><br />	 
			<span class="TB-BODY"> 
			<span class="TB-H1">Naming Rules:</span> <br/>
			<span>          
			For the most part you can name your variable whatever you want as long as you follow the guidelines below.
			<br /> NOTE:Quotation marks surrounding words indicate a variable name. The “”s are not part of the variable name. <br />
