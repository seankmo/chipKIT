		...
		<td>	    
			...
			<span class="TB-BODY"> 
				...
				<ol>
					...
					like <span class="TB-KEYWORD1">void</span>, <span class="TB-KEYWORD3">setup</span> or <span class="TB-LITERAL1">LOW</span> will typically be a
					...
					<li>In our projects, we will use the convention known as <span class="TB-BLACK">lowerCamelCase</span> when naming variables and functions.
						<ul>
							<li>Good function/variable names: <span class="TB-KEYWORD2">pinMode</span>, <span class="TB-KEYWORD2">digitalRead</span>, nameFirst, nameLast</li>
