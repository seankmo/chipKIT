			...
			<tr>
				<td>
					...
					<span class="TB-BODY">
						...
						either <code>HIGH</code> or <code>LOW</code>, as we discussed in
						the <a href="P02.cfm">Blinking the Internal LED project</a>.  When set
						to <code>HIGH</code>, a digital pin maintains a voltage of 3.3V.  Now we can begin
				...
				<td>
					...
					<span class="TB-BODY">
						...
						<cf_TB-TabBox>
							<cf_TB-Tab
								 color="orange"
								 path="P03files/P03Programming_Variables.cfm"
						...
						and thus a variable that represents a pin should have a type of <code>int</code>.
						...
						the variable is actually a constant.  This type specifier is <code>const</code>.
