    ...
    <tr>
      <td valign="top">
         ...
         <span class="TB-BODY">
				...
				will be covered in later projects as they come up.
			</span>
      </td>
    </tr>
  </table>
    ...
    <tr>
	  <td >
		  ...
		  <span class="TB-BODY">
			...
			programming mathematics can be very different than algebraic mathematics.<br>
   ...
   <tr>
	  <td valign="top">
		  ...
		  <span class="TB-BODY">
			...
			<span class="TB-BLACK">long double</span>, this will force the board to use 8 bytes
			for the variable.<br/>
			<table border="1">
				<tr>
			...
			in a later project when it is more applicable.<br/><p/>
			
			Naming a Variable<br/><br/>
...
void do_nothing()
{
  ...
  // void function.
	  ...
	  <td align="center">
      	<img src="func_def.svg" height="200"> <br><br>
...
foo(5,1.3); // calls foo with bar=5 and baz=1.3
	  ...
	  <td align="center">
		<img src="func_elems.svg" height="100"> <br><br>
