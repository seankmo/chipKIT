    ...
    <tr>
	  <td valign="top">
      	...
      	<img src="func_def.svg" height="200"> <br/>
			...
			<span class="TB-BLACK">foo</span> inside the function. Trying to use <span class="TB-BLACK">foo</span> outside 
			of the function will cause a build error, unless <span class="TB-BLACK">foo</span> is defined there as well.
			<br/> 
