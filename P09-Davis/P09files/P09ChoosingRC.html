<html>
	...
	<meta name="Edits Version" content = "P09ChoosingRC-amm-4-16" > 
	<head>
	...
	<table class="TBLAYOUT">
		<tr>
			<td align="center"> <span class="TB-PROJECTTITLE">Project 9: <br>Choosing R and C for our RC circuit</span><br><hr></td>
		</tr>
	</table>
	<br><br> 
	<table class="TBLAYOUT">
	...
	<table class="TBLAYOUT">
		<tr>
			<td align="center"> <br><br>
				<img src="TimeConstantCharge.svg" width="650"/>	</div> <br/><br/> 
				<div class="TB-FIGURES">Fig. 1. RC time constant vs charging capacitor voltage</div>
			</td>
		</tr>
		<tr>
			<td align="center"> <br/><br/>
				<img src="TimeConstantDischarge.svg" width="600"/>	</div><br/><br/>
