...
<cf_Box Color="White" NoMargins="1">
  ...
  <table class="TBLAYOUT" style="width:100%;" cellpadding="0">
	...
	<span class="TB-BODY">
	  ...
	  frequencies of electrical variation <!--Explain what you
	  mean by electrical variation.-->. A properly designed RC
	  ...
	  the rate at which the voltage changes by choosing our
	  resistor and capacitor values properly to get a viable time
	  constant <!--Why is this important? What is the preferable
	  range?-->. For this project, we will use a 10K-0hm resistor
	  and a 10 &micro;F capacitor.  Here is an explanation of what
	  a time constant is
