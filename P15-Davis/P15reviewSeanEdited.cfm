<html>
	...
	<meta name="Edits Version" content = "Seans Edits" > 
	<head>
	...
	<table class="TBLAYOUT" id="ST1-putty">
		<tr>
			<td>
				<span class="TB-H1">Hardware Setup:</span><br><br>
				<span class="TB-BODY"> 
	...
	<table class="TBLAYOUT">
		<tr>
			<td>
				<span class="TB-H1">Switch Statements</span><br><br>
					<span class="TB-BODY">
						<span class="TB-KEYWORD1">switch</span> statements control the flow of a program and are very similar to
        ...
        <pre class="brush: mpide;">
				...
				<span class="TB-BODY">
					...
					This includes the boolean constants <span class="TB-LITERAL1">HIGH</span>, <span class="TB-LITERAL1">LOW</span>, <span class="TB-LITERAL1">INPUT</span>, <span class="TB-LITERAL1">OUTPUT</span>, <span class="TB-KEYWORD1">true</span>, and <span class="TB-KEYWORD1">false</span>. Some data types that cannot be used as a
		...
		<tr>
			<td>
				<span class="TB-BODY"> 
					...
					before and the targeted <span class="TB-KEYWORD1">case</span>. The <span class="TB-KEYWORD1">switch</span> statement,
	...
	<table class="TBLAYOUT" >
		<tr>
			<td>
				<span class="TB-H1">Random Colors:</span><br><br>
				<span class="TB-BODY">
	...
	<table class="TBLAYOUT" >
		<tr>
			<td>
				<span class="TB-H1">Random Color Sweeps:</span><br><br>
				<span class="TB-BODY">
				
					Now that we know how to generate random color combinations and implement color sweeps we can combine the two concepts. In this section we
					will write some code to randomly select a color sweep sequence. Here the order of the sequence will matter. This means there will be 6 different
				...
				<span class="TB-BODY">
					...
					<span class="TB-BLACK">()</span> function we wrote in the color sweeps section to fade the colors in or out. The code needed to implement this is shown below
        ...
        <pre class="brush: mpide;">
					...
					<br>
					<span class="TB-BODY"> 
					Once this code is uploaded the tricolor LED should randomly sweep through different color sequences. The sequence's fade time can be
					...
					<span class="TB-BLACK">()</span>. If you want to delay for periods less than a millisecond you can replace
					the <span class="TB-KEYWORD2">delay</span><span class="TB-BLACK">()</span> line with <span class="TB-KEYWORD2">delayMicroseconds</span>
					<span class="TB-BLACK">(fadeTime)</span> for greater precision. Remember that 1 millisecond is equal to 1000 microseconds, so using delay times
