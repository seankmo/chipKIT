		...
		<tr>
			<td>
				...
				<span class="TB-BODY">
					...
					coding or using a hardware solution. <br><br>
				</span>
			</td>
		</tr>
	</table>
		...
		<tr>
			<td>
				...
				<span class="TB-BODY">
					...
					instead of inside the loop function. We will be using four methods in the Bounce
					...
					true if the pin had a rising edge during the last update and a false otherwise.
					...
					<td>
						...
						<div class="TB-FIGURES">Fig. 2. MPIDE sketchbook location.</div>
					</td>
					</tr></table>
					
					<br><br>
					
					<table><tr><td> Now that you know where the location of your sketchbook is, navigate
					...
					sketch, except that you would click on the library name to do so.
						...
						<div class="TB-FIGURES">Fig. 3. Importing Bounce Library.</div>
					</tr></table>
					...
					the sketch is verified/compiled, it will include the Bounce library.
...
Bounce bouncerGlb(btnPinGlb, debounceDelayGlb);
				...
				<span class="TB-BODY">HERE HERE HERE
